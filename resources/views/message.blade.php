...
<body>
  ...
  <header id="header" class="fixed-top d-flex align-items-center">
    <div class="container d-flex justify-content-between align-items-center">
      ...
      <div class="col-4 logo">
        ...
        <a href="/registration"><img src="{{ public_path().'/assets/images/aurega/logo-white.png' }}" alt="Aurega" class="img-fluid"></a>
      </div>
  ...
  <section class="hero-section" id="hero">
    ...
    <div class="container mt-10">
      <div class="row">
        <div class="col-12">
            <p class="section-heading text-warning text-center mt-5">Thank you for contacting us. Our executive will reach out you shortly!</p>
